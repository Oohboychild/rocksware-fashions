    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="hidden md:flex flex-col justify-between bg-[#0A0A0A] p-16">
        ...
        <div>
          ...
          <h2 className="font-display text-5xl text-[#F5F0E8] leading-tight mb-6">
            Good to see<br />
            <span className="italic text-[#C4956A]">you again</span>
          </h2>
          <p className="text-[#6E6860] font-body font-light text-sm leading-relaxed max-w-xs">
      ...
      <div className="flex flex-col justify-center px-8 md:px-16 lg:px-24 py-16 bg-[#F5F0E8]">
        ...
        <div className="max-w-sm w-full mx-auto">
          ...
          {/* Guest option */}
          <div className="mt-8 pt-8 border-t border-[#EDE8E0]">
            <p className="text-[#6E6860] font-body text-xs text-center mb-4 tracking-wide">
              Or continue without an account
            </p>
            <Link
              href="/checkout?guest=true"
              className="block w-full text-center border border-[#EDE8E0] text-[#6E6860] py-3 text-xs tracking-widest uppercase font-body hover:border-[#0A0A0A] hover:text-[#0A0A0A] transition-colors"
            >
              Guest Checkout
            </Link>
          </div>
